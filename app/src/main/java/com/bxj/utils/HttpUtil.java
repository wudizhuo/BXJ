...
public class HttpUtil {
    ...
    public static InputStream getHtmlInputStream(final String url,
                                                 Boolean isMoblieUrl) throws IOException {
        APIService apiservice = new Retrofit.Builder().baseUrl("http://bbs.hupu.com/").build().create(APIService.class);
        Response<ResponseBody> response = apiservice.getContent(url).execute();
        return response.body().byteStream();
    }


    private static final String TAG = "sunzhuo";
